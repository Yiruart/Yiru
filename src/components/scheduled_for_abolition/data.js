  ...
  list: [
    {
      name: "Modal1",
      model: {
        src: "/models/scheduled_for_abolition/1c.glb",
        position: [0, 0, 0],
        scale: [0.1, 0.1, 0.1],
      },
    },
    {
      name: "Modal2",
      model: {
        src: "/models/scheduled_for_abolition/2c.glb",
        position: [0, 1, 0],
        scale: [0.015, 0.015, 0.015],
        rotation: [Math.PI / 3, Math.PI / 32, Math.PI / 128],
      },
    },
    {
      name: "Modal3",
      model: {
        src: "/models/scheduled_for_abolition/3c.glb",
        position: [0, 0, 0],
